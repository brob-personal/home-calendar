...
.fb-alldaytrack .fb-alldaychip {
  ...
  padding: 0 6px; font-size: 8px; font-weight: 600; height: 17px; line-height: 17px;
...
.fb-wcol.is-today { background: var(--today-shade); }
...
.fb-wbtitle {
  font-size: 8px; font-weight: 700; letter-spacing: -.012em; line-height: 1.15;
  white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;
}
.fb-wblock.is-compact .fb-wbtitle { flex: 0 1 auto; min-width: 0; max-width: none; }
.fb-wbtime {
  font-size: 7px; font-weight: 600; opacity: .64; flex: none;
  white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;
}
