/*
  ...
  rules — the same component renders at 26px in Agenda, 28px in the composer,
  30px in the footer legend, 38px in a Day lane and 44px in Settings. Only the
  circle geometry, the dimmed-when-filtered-out state and the colour dot live
  here.
*/
export default `
/* Avatar */
