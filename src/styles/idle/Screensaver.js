/*
  ...
  .has-photo adds the scrim and flips the text to light. R9 feeds this from
...
.fb-saverscrim {
  ...
  background: linear-gradient(to top, var(--saver-scrim-top), var(--saver-scrim-bottom) 55%, transparent);
}
.fb-savertext {
  position: absolute; left: 46px; bottom: 42px;
  display: flex; flex-direction: column; gap: 3px; color: var(--saver-ink);
}
.fb-saver.has-photo .fb-savertext { color: var(--ink-on-dark); }
